...
# declare a subtour elimination constraint handler
class SubtourEliminationConstraintHandler(scip.Conshdlr):
    ...
    def createCons(self, name, variables):
        ...
        # Here we need to add a dictionary `data` to the constraint
        # that will be made available to the separation subroutines
        # in this class. We mainly need access to the variables.
        constr.data = {}
    ...
    # return a list of subtours, where each element (=cycle) is 
    # given as a list of nodes of that cycle.
    # If no subtours are found, return an empty list
    ...
    def conscheck(self, constr, solution, check_integrality,
        ...
        # ctr contains the model's constraint object
        # that can be used to access the data provided
        # upon creation through `createCons`.
        for ctr in constr:
    ...
    # to the model (use self.model to access the model here)
